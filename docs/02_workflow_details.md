...
MolScout controls reaction-path generation and follow-up molecular analysis through explicit workflow flags. The app wrapper sets those flags for each job, and `core/molscout.py` runs the selected stages.
